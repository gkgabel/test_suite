...
#sleep 5
fio --name=test2 --filename=test4.fio --size=1000m --runtime=60s --ioengine=sync --rw=randwrite --direct=0 --numjobs=8700 --blocksize=4096 --group_reporting=1 --time_based=1  &
