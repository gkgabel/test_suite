...
echo "used mem+shared_mem,used swap,unmov pages,unmov pbs, 2mb huge pages,used mem+shared_mem%,used swap%,unmov pages%,unmov pbs%,2mb huge page %, 25% occupancy,50% occupancy,75% occupancy,100% occupancy,total gups memory footprint">>output.csv
